...
public class Memoization {
     ...
     * @param i righe
     * @param j colonne
     * @return numero di percorsi disponibili (PROGRAMMAZIONE DINAMICA = BOTTOM-UP)
     */
    public static long mahnattanDP (int i, int j) {
        long[] mem = new long[j+1];
        // INIZIALIZZAZIONE VETTORE MEM
        for (int v=0;v<=j;v++) {
            mem[v] = 1;
        }
