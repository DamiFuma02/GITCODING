...
=======
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname hanoiDiskCOPY) (read-case-sensitive #t) (teachpacks ((lib "hanoi.ss" "installed-teachpacks"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "hanoi.ss" "installed-teachpacks")) #f)))
>>>>>>> master
(define hanoi-moves
  (lambda (n)
