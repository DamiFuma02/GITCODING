...
> A differenza di una variabile discreta, quella continua possiede infiniti valori del supporto che essa può assumere
>
> La sua funzione di ripartizione è descritta dalla **funzione di densità**

## FUNZIONE DI DENSITÀ {#contdens}

$$
F_X(x) = \int_{-\infty}^{x}f_X(t)dt, \forall x \in R
$$

## FUNZIONE DI DENSITÀ PROBABILITÀ {#densprob}
