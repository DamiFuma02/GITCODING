...
-   [[**INTRODUZIONE**]{.underline}](#introduzione)

-   [[**VARIABILI STATISTICHE**]{.underline}](#varstat)

-   [[**DISTRIBUZIONI DI FREQUENZA**]{.underline}](#distrfreq)

-   [[**RAPPRESENTAZIONI GRAFICHE**]{.underline}](#grafici)

-   [[**INDICI SINTETICI**]{.underline}](#indici)
...
$$
E(Y) = \frac{1}{n}*\sum_{i=1}^{J}y^c_i*f_i
$$
